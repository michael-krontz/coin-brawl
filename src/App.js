...
const Main = async () => {
  ...
  // Buy
    // const res = await API.rest.Trade.Orders.postOrder({ clientOid: 'qwerty07070707', side: 'buy', symbol: 'DOGE-USDT', type: 'market', funds: 21.7623 });
    // console.log(res);

  // Sell
  //   const res = await API.rest.Trade.Orders.postOrder({ clientOid: 'qwerty07070707', side: 'sell', symbol: 'DOGE-USDT', type: 'market', funds: 114 });
  // console.log(res);
  };
    ...
    <>
      <div className="coin-card">
          ...
          <div className="coin-rank"></div>
            ...
            <button className="buy-button">Select</button>
          </div>
      ...
      <div className="coin-card">
          ...
          <div className="coin-card-content">
            <div className="coin-card-content-left">
              ...
              <div className="coin-price-usd">$1.00</div>
              <div className="coin-price-ticker">+$0.000021 (0.04%)</div>
            </div>
...
function JoinButton() {
  return (
    <button className="join-button" onClick={Main}>Execute</button>
  )
}
...
const ticker2 = atom({
  ...
  default: 'USDT', // default value (aka initial value)
});

const name2 = atom({
  key: 'name2', // unique ID (with respect to other atoms/selectors)
  default: 'Tether', // default value (aka initial value)
});
